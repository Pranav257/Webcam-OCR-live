...
def main():
    ...
    while running:
        ...
        # Convert the flipped frame to PIL image for processing
        img_pil = Image.fromarray(cv2.cvtColor(frame, cv2.COLOR_BGR2RGB))
        
        # Process frame for text extraction
        ...
        # Check the recognition_output and ensure proper unpacking
        ...
        # Convert and display frame in Pygame window
